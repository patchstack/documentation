...
To view your site hardening settings, navigate to **Sites** > **yourdomain.com** > **Hardening** in Patchstack App.

![](@images/patchstack-hardening-general.png)

On this page you can manage the following security settings of your site:
