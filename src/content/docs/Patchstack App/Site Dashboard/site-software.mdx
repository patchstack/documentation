...
Click a column header — Status, Type, Package, Vulnerabilities or Version — to sort the table by it; click again to reverse the order. Sorting by Vulnerabilities puts the most urgent first: unprotected vulnerabilities by priority, then mitigated ones, then everything else.
