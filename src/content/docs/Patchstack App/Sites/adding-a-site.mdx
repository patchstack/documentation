...
**JavaScript and Node.js projects do not need this flow.** Installing [`@patchstack/connect`](/getting-started/installing-patchstack/installing-on-javascript-node-projects/) and running `setup` creates the site for you on its first scan, then prints a link that attaches it to your account. See [Pulse sites overview](/patchstack-app/pulse/pulse-overview/) for what those sites look like in the app.
