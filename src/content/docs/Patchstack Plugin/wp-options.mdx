...
| ip_header_computed | bool | 0 | Indiciation if we computed the proxy IP header |
| ip_header_force_compute | bool | 0 | Whether or not to force a new IP header compution |
...
| software_upload_attempted | bool | 0 | Whether or not we attempted a software sync yet |
...
| license_free | bool | 0 | Whether or not the subscription is a free user or not |
...
| managed | bool | 0 | Whether or not this site is third-party managed |
...
| firewall_ap_enabled | bool | 0 | Whether or not auto prepend functionality is enabled |
| firewall_log_processing | bool | 0 | Whether or not firewall logs are currently being synced |
| firewall_log_ap_processing | bool | 0 | Whether or not auto prepend firewall logs are currently being synced |
| eventlog_log_processing | bool | 0 | Whether or not activity logs are currently being synced |
