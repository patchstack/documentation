...
### Standard tier
Fetch the latest vulnerability information for a single version of a particular plugin, theme or WordPress core. API is limited for 5000 calls / 24 hours.
...
<LinkButton
  href="/api-solutions/threat-intelligence-api/extended/"
  variant="primary"
  icon="open-book"
  iconPlacement="start"
>
